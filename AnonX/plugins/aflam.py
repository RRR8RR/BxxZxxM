"""
        ...
        [InlineKeyboardButton("عــلــشᯓ𓆩 | 🇮🇶 ˹", callback_data="moslsl " + str(m.from_user.id))],
...
async def film(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("عــلــشᯓ𓆩 | 🇮🇶 ˹", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ⌝⚡", url=f"https://t.me/xLxLxLrr3")],
...
async def comedy(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("عــلــشᯓ𓆩 | 🇮🇶 ˹", callback_data="film " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ⌝⚡", url=f"https://t.me/xLxLxLrr3")],
...
async def Xms1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("عــلــشᯓ𓆩 | 🇮🇶 ˹", callback_data="msrahia " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ⌝⚡", url=f"https://t.me/xLxLxLrr3")],
...
async def Xmsrh1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("عــلــشᯓ𓆩 | 🇮🇶 ˹", callback_data="Xms1 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ ⩹━⊷⌯ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ⌝⚡", url=f"https://t.me/xLxLxLrr3")],
